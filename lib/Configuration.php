...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://sandbox.api.visa.com/cybersource/';
    ...
    {
        return self::getDefaultConfiguration()->apiKey;
    }
    ...
    {
        return self::getDefaultConfiguration()->sharedSecret;
    }
    ...
    {
        $report  = "PHP SDK (CyberSource) Debug Report:\n";
        $report .= "    OS: ".php_uname()."\n";
